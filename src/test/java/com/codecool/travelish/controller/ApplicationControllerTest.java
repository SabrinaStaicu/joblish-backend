...
//    @Test
//    void getAllByUser_responseOk() throws Exception {
//        mockMvc.perform(
//                MockMvcRequestBuilders.get("/applications/by-user-id/{id}", 3L)
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andExpect(MockMvcResultMatchers.jsonPath("$[0].job.title",is("Back end developer")));
//    }
//
//    @Test
//    void getAllByJobId_responseOk() throws Exception {
//        mockMvc.perform(
//                MockMvcRequestBuilders.get("/applications/filter-by-job/{id}", 2L)
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andExpect(MockMvcResultMatchers.jsonPath("$[0].job.title",is("Back end developer")));
//    }
...
//            GenericEntity foundEntity = genericEntityRepository.getById(genericEntity.getId());
        ...
        Job job1 = jobsRepository.save(job);
        Application application1 = applicationRepository.save(application);
        System.out.println(appUser1.getId());
